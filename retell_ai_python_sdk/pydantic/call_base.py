...
from retell_ai_python_sdk.pydantic.call_base_retell_llm_dynamic_variables import CallBaseRetellLlmDynamicVariables
...
class CallBase(BaseModel):
    ...
    audio_websocket_protocol: Literal["web", "twilio"] = Field(alias='audio_websocket_protocol')
    ...
    audio_encoding: Literal["s16le", "mulaw"] = Field(alias='audio_encoding')
    ...
    call_status: Literal["registered", "ongoing", "ended", "error"] = Field(alias='call_status')

    # Begin timestamp (milliseconds since epoch) of the call.
    start_timestamp: int = Field(alias='start_timestamp')
    ...
    end_call_after_silence_ms: typing.Optional[int] = Field(None, alias='end_call_after_silence_ms')
    ...
    from_number: typing.Optional[str] = Field(None, alias='from_number')
    ...
    to_number: typing.Optional[str] = Field(None, alias='to_number')
    ...
    retell_llm_dynamic_variables: typing.Optional[CallBaseRetellLlmDynamicVariables] = Field(None, alias='retell_llm_dynamic_variables')
