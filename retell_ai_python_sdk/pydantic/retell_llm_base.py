...
from retell_ai_python_sdk.pydantic.state import State
from retell_ai_python_sdk.pydantic.tool import Tool

class RetellLLMBase(BaseModel):
    ...
    general_prompt: typing.Optional[str] = Field(None, alias='general_prompt')
    ...
    general_tools: typing.Optional[typing.List[Tool]] = Field(None, alias='general_tools')
    ...
    states: typing.Optional[typing.List[State]] = Field(None, alias='states')

    # Name of the starting state. Required if states is not empty.
    starting_state: typing.Optional[str] = Field(None, alias='starting_state')
    ...
    begin_message: typing.Optional[str] = Field(None, alias='begin_message')
