...
from retell_ai_python_sdk.pydantic.call_establish_connection_request_retell_llm_dynamic_variables import CallEstablishConnectionRequestRetellLlmDynamicVariables

class CallEstablishConnectionRequest(BaseModel):
    ...
    retell_llm_dynamic_variables: typing.Optional[CallEstablishConnectionRequestRetellLlmDynamicVariables] = Field(None, alias='retell_llm_dynamic_variables')
