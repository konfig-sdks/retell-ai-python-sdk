...
from retell_ai_python_sdk.model.agent_create_new_agent_request import AgentCreateNewAgentRequest as AgentCreateNewAgentRequestSchema
...
from retell_ai_python_sdk.type.agent_create_new_agent_request import AgentCreateNewAgentRequest
...
from retell_ai_python_sdk.pydantic.agent_create_new_agent_request import AgentCreateNewAgentRequest as AgentCreateNewAgentRequestPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AgentCreateNewAgentRequestSchema


request_body_agent_create_new_agent_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AgentResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_agent_mapped_args(
        self,
        body: AgentCreateNewAgentRequest,
    ...
    async def _acreate_new_agent_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/create-agent',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_agent_create_new_agent_request.serialize(body, content_type)
...
class CreateNewAgentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_agent(
        self,
        body: AgentCreateNewAgentRequest,
        llm_websocket_url: typing.Optional[str] = None,
        voice_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_agent_mapped_args(
            body=body,
        ...
        return await self._acreate_new_agent_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_agent(
        ...
        return self._create_new_agent_oapg(
            body=args.body,
        )

class CreateNewAgent(BaseApi):
    ...
    async def acreate_new_agent(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_agent(
            body=body,
            llm_websocket_url=llm_websocket_url,
            voice_id=voice_id,
            voice_temperature=voice_temperature,
    ...
    def create_new_agent(
        ...
        raw_response = self.raw.create_new_agent(
            body=body,
            llm_websocket_url=llm_websocket_url,
            voice_id=voice_id,
            voice_temperature=voice_temperature,
