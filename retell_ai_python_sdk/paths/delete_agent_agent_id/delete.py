...
class BaseApi(api_client.Api):
    ...
    def _delete_existing_agent_mapped_args(
        self,
        agent_id: str,
    ...
    async def _adelete_existing_agent_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/delete-agent/{agent_id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_existing_agent_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteExistingAgentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_existing_agent(
        self,
        agent_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_existing_agent_mapped_args(
            agent_id=agent_id,
        )
        return await self._adelete_existing_agent_oapg(
    ...
    def delete_existing_agent(
        ...
        return self._delete_existing_agent_oapg(
            path_params=args.path,
        )

class DeleteExistingAgent(BaseApi):
    ...
    async def adelete_existing_agent(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_existing_agent(
            agent_id=agent_id,
            **kwargs,
        )
    ...
    def delete_existing_agent(
        ...
        raw_response = self.raw.delete_existing_agent(
            agent_id=agent_id,
        )
