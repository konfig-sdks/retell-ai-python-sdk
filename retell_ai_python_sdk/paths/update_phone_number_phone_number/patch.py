...
from retell_ai_python_sdk.model.phone_number_update_retell_llm_request import PhoneNumberUpdateRetellLlmRequest as PhoneNumberUpdateRetellLlmRequestSchema
...
from retell_ai_python_sdk.type.phone_number_update_retell_llm_request import PhoneNumberUpdateRetellLlmRequest
...
from retell_ai_python_sdk.pydantic.phone_number_update_retell_llm_request import PhoneNumberUpdateRetellLlmRequest as PhoneNumberUpdateRetellLlmRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PhoneNumberUpdateRetellLlmRequestSchema


request_body_phone_number_update_retell_llm_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PhoneNumberResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_retell_llm_mapped_args(
        self,
        agent_id: str,
        phone_number: str,
    ...
    async def _aupdate_retell_llm_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/update-phone-number/{phone_number}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_phone_number_update_retell_llm_request.serialize(body, content_type)
...
class UpdateRetellLlmRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_retell_llm(
        self,
        agent_id: str,
        phone_number: str,
        **kwargs,
        ...
        args = self._update_retell_llm_mapped_args(
            agent_id=agent_id,
            phone_number=phone_number,
        )
        return await self._aupdate_retell_llm_oapg(
            body=args.body,
    ...
    def update_retell_llm(
        ...
        return self._update_retell_llm_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateRetellLlm(BaseApi):
    ...
    async def aupdate_retell_llm(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_retell_llm(
            agent_id=agent_id,
            phone_number=phone_number,
            **kwargs,
        )
    ...
    def update_retell_llm(
        ...
        raw_response = self.raw.update_retell_llm(
            agent_id=agent_id,
            phone_number=phone_number,
        )
        if validate:
