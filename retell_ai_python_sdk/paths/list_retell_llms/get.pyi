...
from retell_ai_python_sdk.model.retell_llm_list_all_response import RetellLlmListAllResponse as RetellLlmListAllResponseSchema
...
from retell_ai_python_sdk.type.retell_llm_list_all_response import RetellLlmListAllResponse
...
from retell_ai_python_sdk.pydantic.retell_llm_list_all_response import RetellLlmListAllResponse as RetellLlmListAllResponsePydantic

SchemaFor200ResponseBodyApplicationJson = RetellLlmListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: RetellLlmListAllResponse
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/list-retell-llms',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RetellLlmListAllResponsePydantic:
        raw_response = await self.raw.alist_all(
            **kwargs,
        )
        if validate:
            return RootModel[RetellLlmListAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(RetellLlmListAllResponsePydantic, raw_response.body)
