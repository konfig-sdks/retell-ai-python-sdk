...
from retell_ai_python_sdk.model.state import State as StateSchema
...
from retell_ai_python_sdk.model.retell_llm_base import RetellLLMBase as RetellLLMBaseSchema
from retell_ai_python_sdk.model.tool import Tool as ToolSchema
...
from retell_ai_python_sdk.type.retell_llm_base import RetellLLMBase
...
from retell_ai_python_sdk.pydantic.tool import Tool as ToolPydantic
from retell_ai_python_sdk.pydantic.state import State as StatePydantic
from retell_ai_python_sdk.pydantic.retell_llm_base import RetellLLMBase as RetellLLMBasePydantic
...
# body param
SchemaForRequestBodyApplicationJson = RetellLLMBaseSchema


request_body_retell_llm_base = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RetellLLMResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _new_llm_mapped_args(
        self,
        general_prompt: typing.Optional[str] = None,
        general_tools: typing.Optional[typing.List[Tool]] = None,
        states: typing.Optional[typing.List[State]] = None,
        starting_state: typing.Optional[str] = None,
        begin_message: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _body = {}
        if general_prompt is not None:
            _body["general_prompt"] = general_prompt
        if general_tools is not None:
            _body["general_tools"] = general_tools
        if states is not None:
            _body["states"] = states
        if starting_state is not None:
            _body["starting_state"] = starting_state
        if begin_message is not None:
            _body["begin_message"] = begin_message
        args.body = _body
        return args

    async def _anew_llm_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/create-retell-llm',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_retell_llm_base.serialize(body, content_type)
...
class NewLlmRaw(BaseApi):
    ...
    async def anew_llm(
        ...
        **kwargs,
        ...
        args = self._new_llm_mapped_args(
        ...
        return await self._anew_llm_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def new_llm(
        ...
        return self._new_llm_oapg(
            body=args.body,
        )

class NewLlm(BaseApi):
    ...
    async def anew_llm(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.anew_llm(
            general_prompt=general_prompt,
            general_tools=general_tools,
            states=states,
            starting_state=starting_state,
