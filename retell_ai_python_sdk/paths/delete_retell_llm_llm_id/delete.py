    ...
    async def _adelete_llm_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/delete-retell-llm/{llm_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteLlmRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_llm(
        self,
        llm_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_llm_mapped_args(
            llm_id=llm_id,
        )
        return await self._adelete_llm_oapg(
    ...
    def delete_llm(
        ...
        return self._delete_llm_oapg(
            path_params=args.path,
        )

class DeleteLlm(BaseApi):
    ...
    async def adelete_llm(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_llm(
            llm_id=llm_id,
            **kwargs,
        )
    ...
    def delete_llm(
        ...
        raw_response = self.raw.delete_llm(
            llm_id=llm_id,
        )
