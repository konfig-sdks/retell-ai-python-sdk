...
class BaseApi(api_client.Api):
    ...
    def _remove_phone_number_mapped_args(
        self,
        phone_number: str,
    ...
    async def _aremove_phone_number_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/delete-phone-number/{phone_number}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemovePhoneNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_phone_number(
        self,
        phone_number: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_phone_number_mapped_args(
            phone_number=phone_number,
        )
        return await self._aremove_phone_number_oapg(
    ...
    def remove_phone_number(
        ...
        return self._remove_phone_number_oapg(
            path_params=args.path,
        )

class RemovePhoneNumber(BaseApi):
    ...
    async def aremove_phone_number(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_phone_number(
            phone_number=phone_number,
            **kwargs,
        )
    ...
    def remove_phone_number(
        ...
        raw_response = self.raw.remove_phone_number(
            phone_number=phone_number,
        )
