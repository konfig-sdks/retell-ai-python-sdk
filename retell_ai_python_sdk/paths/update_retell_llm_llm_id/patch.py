    ...
    async def _aupdate_llm_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/update-retell-llm/{llm_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdateLlmRaw(BaseApi):
    ...
    async def aupdate_llm(
        ...
        **kwargs,
        ...
        args = self._update_llm_mapped_args(
            llm_id=llm_id,
        ...
        return await self._aupdate_llm_oapg(
            body=args.body,
    ...
    def update_llm(
        ...
        return self._update_llm_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateLlm(BaseApi):
    ...
    async def aupdate_llm(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_llm(
            llm_id=llm_id,
            general_prompt=general_prompt,
            general_tools=general_tools,
            states=states,
    ...
    def update_llm(
        ...
        raw_response = self.raw.update_llm(
            llm_id=llm_id,
            general_prompt=general_prompt,
            general_tools=general_tools,
            states=states,
