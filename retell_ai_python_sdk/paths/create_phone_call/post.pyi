...
from retell_ai_python_sdk.model.call_make_connection_request_retell_llm_dynamic_variables import CallMakeConnectionRequestRetellLlmDynamicVariables as CallMakeConnectionRequestRetellLlmDynamicVariablesSchema
...
from retell_ai_python_sdk.model.call_make_connection_request import CallMakeConnectionRequest as CallMakeConnectionRequestSchema
...
from retell_ai_python_sdk.model.call_make_connection_request_phone_number import CallMakeConnectionRequestPhoneNumber as CallMakeConnectionRequestPhoneNumberSchema
...
from retell_ai_python_sdk.type.call_make_connection_request import CallMakeConnectionRequest
...
from retell_ai_python_sdk.pydantic.call_make_connection_request_phone_number import CallMakeConnectionRequestPhoneNumber as CallMakeConnectionRequestPhoneNumberPydantic
from retell_ai_python_sdk.pydantic.call_make_connection_request_retell_llm_dynamic_variables import CallMakeConnectionRequestRetellLlmDynamicVariables as CallMakeConnectionRequestRetellLlmDynamicVariablesPydantic
from retell_ai_python_sdk.pydantic.call_make_connection_request import CallMakeConnectionRequest as CallMakeConnectionRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = CallMakeConnectionRequestSchema


request_body_call_make_connection_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _make_connection_mapped_args(
        self,
        phone_number: CallMakeConnectionRequestPhoneNumber,
        override_agent_id: typing.Optional[str] = None,
        retell_llm_dynamic_variables: typing.Optional[CallMakeConnectionRequestRetellLlmDynamicVariables] = None,
    ...
    async def _amake_connection_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/create-phone-call',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_call_make_connection_request.serialize(body, content_type)
...
class MakeConnectionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amake_connection(
        self,
        phone_number: CallMakeConnectionRequestPhoneNumber,
        override_agent_id: typing.Optional[str] = None,
        retell_llm_dynamic_variables: typing.Optional[CallMakeConnectionRequestRetellLlmDynamicVariables] = None,
        **kwargs,
        ...
        args = self._make_connection_mapped_args(
            phone_number=phone_number,
            override_agent_id=override_agent_id,
            retell_llm_dynamic_variables=retell_llm_dynamic_variables,
        )
        return await self._amake_connection_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def make_connection(
        ...
        return self._make_connection_oapg(
            body=args.body,
        )

class MakeConnection(BaseApi):
    ...
    async def amake_connection(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amake_connection(
            phone_number=phone_number,
            override_agent_id=override_agent_id,
            retell_llm_dynamic_variables=retell_llm_dynamic_variables,
            **kwargs,
    ...
    def make_connection(
        ...
        raw_response = self.raw.make_connection(
            phone_number=phone_number,
            override_agent_id=override_agent_id,
            retell_llm_dynamic_variables=retell_llm_dynamic_variables,
        )
