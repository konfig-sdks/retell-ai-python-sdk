...
from retell_ai_python_sdk.model.call_establish_connection_request import CallEstablishConnectionRequest as CallEstablishConnectionRequestSchema
...
from retell_ai_python_sdk.model.call_establish_connection402_response import CallEstablishConnection402Response as CallEstablishConnection402ResponseSchema
from retell_ai_python_sdk.model.call_base import CallBase as CallBaseSchema
...
from retell_ai_python_sdk.model.call_establish_connection_request_retell_llm_dynamic_variables import CallEstablishConnectionRequestRetellLlmDynamicVariables as CallEstablishConnectionRequestRetellLlmDynamicVariablesSchema
from retell_ai_python_sdk.model.call_establish_connection429_response import CallEstablishConnection429Response as CallEstablishConnection429ResponseSchema
...
from retell_ai_python_sdk.type.call_establish_connection402_response import CallEstablishConnection402Response
from retell_ai_python_sdk.type.call_establish_connection_request import CallEstablishConnectionRequest
from retell_ai_python_sdk.type.call_base import CallBase
from retell_ai_python_sdk.type.call_establish_connection429_response import CallEstablishConnection429Response
...
from retell_ai_python_sdk.pydantic.call_base import CallBase as CallBasePydantic
...
from retell_ai_python_sdk.pydantic.call_establish_connection_request import CallEstablishConnectionRequest as CallEstablishConnectionRequestPydantic
from retell_ai_python_sdk.pydantic.call_establish_connection402_response import CallEstablishConnection402Response as CallEstablishConnection402ResponsePydantic
...
from retell_ai_python_sdk.pydantic.call_establish_connection_request_retell_llm_dynamic_variables import CallEstablishConnectionRequestRetellLlmDynamicVariables as CallEstablishConnectionRequestRetellLlmDynamicVariablesPydantic
from retell_ai_python_sdk.pydantic.call_establish_connection429_response import CallEstablishConnection429Response as CallEstablishConnection429ResponsePydantic

# body param
SchemaForRequestBodyApplicationJson = CallEstablishConnectionRequestSchema


request_body_call_establish_connection_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CallBaseSchema
...
SchemaFor402ResponseBodyApplicationJson = CallEstablishConnection402ResponseSchema


@dataclass
class ApiResponseFor402(api_client.ApiResponse):
    body: CallEstablishConnection402Response
...
SchemaFor429ResponseBodyApplicationJson = CallEstablishConnection429ResponseSchema


@dataclass
class ApiResponseFor429(api_client.ApiResponse):
    body: CallEstablishConnection429Response
...
class BaseApi(api_client.Api):
    ...
    def _establish_connection_mapped_args(
        ...
        audio_encoding: str,
        sample_rate: int,
        end_call_after_silence_ms: typing.Optional[int] = None,
        ...
        retell_llm_dynamic_variables: typing.Optional[CallEstablishConnectionRequestRetellLlmDynamicVariables] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _body = {}
        if agent_id is not None:
            _body["agent_id"] = agent_id
        if audio_websocket_protocol is not None:
            _body["audio_websocket_protocol"] = audio_websocket_protocol
        if audio_encoding is not None:
            _body["audio_encoding"] = audio_encoding
        if sample_rate is not None:
            _body["sample_rate"] = sample_rate
        if end_call_after_silence_ms is not None:
            _body["end_call_after_silence_ms"] = end_call_after_silence_ms
        if from_number is not None:
            _body["from_number"] = from_number
        if to_number is not None:
            _body["to_number"] = to_number
        if metadata is not None:
            _body["metadata"] = metadata
        if retell_llm_dynamic_variables is not None:
            _body["retell_llm_dynamic_variables"] = retell_llm_dynamic_variables
        args.body = _body
        return args
    ...
    async def _aestablish_connection_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/register-call',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_call_establish_connection_request.serialize(body, content_type)
...
class EstablishConnection(BaseApi):
    ...
    async def aestablish_connection(
        ...
        **kwargs,
        ...
        if validate:
            return CallBasePydantic(**raw_response.body)
        return api_client.construct_model_instance(CallBasePydantic, raw_response.body)
