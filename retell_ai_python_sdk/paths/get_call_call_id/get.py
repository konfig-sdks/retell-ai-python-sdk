...
from retell_ai_python_sdk.model.call_detail import CallDetail as CallDetailSchema
...
from retell_ai_python_sdk.type.call_detail import CallDetail
...
from retell_ai_python_sdk.pydantic.call_detail import CallDetail as CallDetailPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'call_id': typing.Union[CallIdSchema, str, ],
    }
)
...
request_path_call_id = api_client.PathParameter(
    name="call_id",
...
SchemaFor200ResponseBodyApplicationJson = CallDetailSchema
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/get-call/{call_id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[CallDetailPydantic](raw_response.body).root
        return api_client.construct_model_instance(CallDetailPydantic, raw_response.body)
