...
from retell_ai_python_sdk.model.agent_get_all_response import AgentGetAllResponse as AgentGetAllResponseSchema
...
from retell_ai_python_sdk.type.agent_get_all_response import AgentGetAllResponse
...
from retell_ai_python_sdk.pydantic.agent_get_all_response import AgentGetAllResponse as AgentGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AgentGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AgentGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AgentGetAllResponsePydantic:
        raw_response = await self.raw.aget_all(
            **kwargs,
        )
        if validate:
            return RootModel[AgentGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AgentGetAllResponsePydantic, raw_response.body)
