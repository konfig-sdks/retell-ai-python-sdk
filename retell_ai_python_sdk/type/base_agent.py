...
class RequiredBaseAgent(TypedDict):
    pass

class OptionalBaseAgent(TypedDict, total=False):
    ...
    voice_temperature: typing.Union[int, float]
    ...
    voice_speed: typing.Union[int, float]
    ...
    responsiveness: typing.Union[int, float]
    ...
    boosted_keywords: BaseAgentBoostedKeywords
...
class BaseAgent(RequiredBaseAgent, OptionalBaseAgent):
    pass
