...
from retell_ai_python_sdk.type.call_base_retell_llm_dynamic_variables import CallBaseRetellLlmDynamicVariables

class RequiredCallBase(TypedDict):
...
class OptionalCallBase(TypedDict, total=False):
    ...
    retell_llm_dynamic_variables: CallBaseRetellLlmDynamicVariables

class CallBase(RequiredCallBase, OptionalCallBase):
    pass
