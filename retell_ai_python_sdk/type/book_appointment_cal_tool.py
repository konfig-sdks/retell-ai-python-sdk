...
class RequiredBookAppointmentCalTool(TypedDict):
    type: str
...
class OptionalBookAppointmentCalTool(TypedDict, total=False):
...
class BookAppointmentCalTool(RequiredBookAppointmentCalTool, OptionalBookAppointmentCalTool):
    pass
